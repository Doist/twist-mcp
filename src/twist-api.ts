...
export class TwistApi {
    ...
    async getPublicChannels(id: number): Promise<Channel[]> {
        return this.request<Channel[]>({
            method: 'GET',
            url: 'workspaces/get_public_channels',
            params: { id },
        })
    }
    ...
    async moveThread(id: number, to_channel_id: number): Promise<void> {
        return this.request<void>({
            method: 'POST',
            url: 'threads/move_to_channel',
            data: { id, to_channel_id },
        })
    }
    ...
    async getOrCreateConversation(
        ...
        return this.request<Conversation>({
            method: 'POST',
            url: 'conversations/get_or_create',
            data: { workspace_id, user_ids },
        })
    }
    ...
    async getMessage(id: number): Promise<Message> {
        return this.request<Message>({
            method: 'GET',
            url: 'conversation_messages/getone',
            params: { id },
        })
    }
    ...
    async updateMessage(id: number, content: string): Promise<Message> {
        return this.request<Message>({
            method: 'POST',
            url: 'conversation_messages/update',
            data: { id, content },
        })
    }
